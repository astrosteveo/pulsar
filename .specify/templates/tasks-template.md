...
- Push to remote regularly: `git push origin [###-feature-name]`
- Run all tests before each push to ensure nothing is broken

**AFTER COMPLETING ALL TASKS:**

1. Ensure all tests pass: run full test suite
2. Push final changes: `git push origin [###-feature-name]`
3. Open Pull Request (PR) from `[###-feature-name]` to `main`
